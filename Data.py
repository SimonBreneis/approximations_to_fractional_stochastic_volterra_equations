...
fBm_errors_AK_original = [1.093956, 1.038641, 1.008279, 0.987654, 0.959794, 0.940801, 0.920437, 0.897258, 0.875517,
                          0.856277,
                          0.836913, 0.817406, 0.798393, 0.780402, 0.762558, 0.745117, 0.728091, 0.711447, 0.695196,
                          0.679308]
...
rHeston_psi_1048576 = np.array(
    [-4.786493744137755e-05 + 0.009001370091122604j, -0.23626350731140552 - 0.0010043112607593682j])
...
rHeston_psi_adaptive_1024 = np.array(
    [-4.808868651379933e-05 + 0.009002184905100123j, -0.2373427877401934 - 0.0010120619893089458j])
...
def plot_rHeston_optimized_smiles():
    ...
    plt.plot(k_100, rHeston_1_100, color(0, 5), label=f'{1}-dimensional approximation')
    plt.plot(k_100, rHeston_2_100, color(1, 5), label=f'{2}-dimensional approximation')
    plt.plot(k_100, rHeston_3_100, color(2, 5), label=f'{3}-dimensional approximation')
    plt.plot(k_100, rHeston_4_100, color(3, 5), label=f'{4}-dimensional approximation')
    plt.plot(k_100, rHeston_5_100, color(4, 5), label=f'{5}-dimensional approximation')
    plt.xlabel('log-moneyness')
    plt.ylabel('implied volatility')
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.plot(k_100, rel_errors_1_100, color(0, 5), label=f'{1}-dimensional quadrature error')
    plt.plot(k_100, rel_errors_2_100, color(1, 5), label=f'{2}-dimensional quadrature error')
    plt.plot(k_100, rel_errors_3_100, color(2, 5), label=f'{3}-dimensional quadrature error')
    plt.plot(k_100, rel_errors_4_100, color(3, 5), label=f'{4}-dimensional quadrature error')
    plt.plot(k_100, rel_errors_5_100, color(4, 5), label=f'{5}-dimensional quadrature error')
    plt.xlabel('log-moneyness')
    ...
    plt.plot(k_100[62:-40], rel_errors_1_100[62:-40], color(0, 5), label=f'{1}-dimensional quadrature error')
    plt.plot(k_100[62:-40], rel_errors_2_100[62:-40], color(1, 5), label=f'{2}-dimensional quadrature error')
    plt.plot(k_100[62:-40], rel_errors_3_100[62:-40], color(2, 5), label=f'{3}-dimensional quadrature error')
    plt.plot(k_100[62:-40], rel_errors_4_100[62:-40], color(3, 5), label=f'{4}-dimensional quadrature error')
    plt.plot(k_100[62:-40], rel_errors_5_100[62:-40], color(4, 5), label=f'{5}-dimensional quadrature error')
    plt.xlabel('log-moneyness')
    plt.ylabel('relative error')
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.plot(k_100, rHeston_100, 'k-', label='rough Heston')
    plt.plot(k_100, rHeston_obs_2_100, color(0, 5), label=f'{2}-dimensional approximation')
    plt.plot(k_100, rHeston_obs_4_100, color(1, 5), label=f'{4}-dimensional approximation')
    plt.plot(k_100, rHeston_obs_8_100, color(2, 5), label=f'{8}-dimensional approximation')
    plt.plot(k_100, rHeston_obs_16_100, color(3, 5), label=f'{16}-dimensional approximation')
    plt.plot(k_100, rHeston_obs_32_100, color(4, 5), label=f'{32}-dimensional approximation')
    plt.xlabel('log-moneyness')
    plt.ylabel('implied volatility')
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.plot(k_100, rel_errors_obs_2_100, color(0, 5), label=f'2 dimensions, paper')
    plt.plot(k_100, rel_errors_obs_4_100, color(1, 5), label=f'4 dimensions, paper')
    plt.plot(k_100, rel_errors_obs_8_100, color(2, 5), label=f'8 dimensions, paper')
    plt.plot(k_100, rel_errors_obs_16_100, color(3, 5), label=f'16 dimensions, paper')
    plt.plot(k_100, rel_errors_obs_32_100, color(4, 5), label=f'32 dimensions, paper')
    plt.xlabel('log-moneyness')
    plt.ylabel('relative error')
    plt.legend(loc='best')
    plt.yscale('log')
    ...
    plt.plot(k_010, rHeston_1_010, color(0, 5), label=f'{1}-dimensional approximation')
    plt.plot(k_010, rHeston_2_010, color(1, 5), label=f'{2}-dimensional approximation')
    plt.plot(k_010, rHeston_3_010, color(2, 5), label=f'{3}-dimensional approximation')
    plt.plot(k_010, rHeston_4_010, color(3, 5), label=f'{4}-dimensional approximation')
    plt.plot(k_010, rHeston_5_010, color(4, 5), label=f'{5}-dimensional approximation')
    plt.xlabel('log-moneyness')
    plt.ylabel('implied volatility')
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.plot(k_010, rel_errors_1_010, color(0, 5), label=f'{1}-dimensional quadrature error')
    plt.plot(k_010, rel_errors_2_010, color(1, 5), label=f'{2}-dimensional quadrature error')
    plt.plot(k_010, rel_errors_3_010, color(2, 5), label=f'{3}-dimensional quadrature error')
    plt.plot(k_010, rel_errors_4_010, color(3, 5), label=f'{4}-dimensional quadrature error')
    plt.plot(k_010, rel_errors_5_010, color(4, 5), label=f'{5}-dimensional quadrature error')
    plt.xlabel('log-moneyness')
    plt.ylabel('relative error')
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.plot(k_010[:-46], rel_errors_1_010[:-46], color(0, 5), label=f'{1}-dimensional quadrature error')
    plt.plot(k_010[:-46], rel_errors_2_010[:-46], color(1, 5), label=f'{2}-dimensional quadrature error')
    plt.plot(k_010[:-46], rel_errors_3_010[:-46], color(2, 5), label=f'{3}-dimensional quadrature error')
    plt.plot(k_010[:-46], rel_errors_4_010[:-46], color(3, 5), label=f'{4}-dimensional quadrature error')
    plt.plot(k_010[:-46], rel_errors_5_010[:-46], color(4, 5), label=f'{5}-dimensional quadrature error')
    plt.xlabel('log-moneyness')
    plt.ylabel('relative error')
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.plot(k_010, rHeston_010, 'k-', label='rough Heston')
    plt.plot(k_010, rHeston_obs_2_010, color(0, 5), label=f'{2}-dimensional approximation')
    plt.plot(k_010, rHeston_obs_4_010, color(1, 5), label=f'{4}-dimensional approximation')
    plt.plot(k_010, rHeston_obs_8_010, color(2, 5), label=f'{8}-dimensional approximation')
    plt.plot(k_010, rHeston_obs_16_010, color(3, 5), label=f'{16}-dimensional approximation')
    plt.plot(k_010, rHeston_obs_32_010, color(4, 5), label=f'{32}-dimensional approximation')
    plt.xlabel('log-moneyness')
    plt.ylabel('implied volatility')
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.plot(k_010, rel_errors_obs_2_010, color(0, 5), label=f'2 dimensions, paper')
    plt.plot(k_010, rel_errors_obs_4_010, color(1, 5), label=f'4 dimensions, paper')
    plt.plot(k_010, rel_errors_obs_8_010, color(2, 5), label=f'8 dimensions, paper')
    plt.plot(k_010, rel_errors_obs_16_010, color(3, 5), label=f'16 dimensions, paper')
    plt.plot(k_010, rel_errors_obs_32_010, color(4, 5), label=f'32 dimensions, paper')
    plt.xlabel('log-moneyness')
    plt.ylabel('relative error')
    plt.legend(loc='best')
    plt.yscale('log')
    ...
    plt.plot(k_001, rHeston_1_001, color(0, 5), label=f'{1}-dimensional approximation')
    plt.plot(k_001, rHeston_2_001, color(1, 5), label=f'{2}-dimensional approximation')
    plt.plot(k_001, rHeston_3_001, color(2, 5), label=f'{3}-dimensional approximation')
    plt.plot(k_001, rHeston_4_001, color(3, 5), label=f'{4}-dimensional approximation')
    plt.plot(k_001, rHeston_5_001, color(4, 5), label=f'{5}-dimensional approximation')
    plt.xlabel('log-moneyness')
    plt.ylabel('implied volatility')
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.plot(k_001, rel_errors_1_001, color(0, 5), label=f'{1}-dimensional quadrature error')
    plt.plot(k_001, rel_errors_2_001, color(1, 5), label=f'{2}-dimensional quadrature error')
    plt.plot(k_001, rel_errors_3_001, color(2, 5), label=f'{3}-dimensional quadrature error')
    plt.plot(k_001, rel_errors_4_001, color(3, 5), label=f'{4}-dimensional quadrature error')
    plt.plot(k_001, rel_errors_5_001, color(4, 5), label=f'{5}-dimensional quadrature error')
    plt.xlabel('log-moneyness')
    plt.ylabel('relative error')
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.plot(k_001[:-43], rel_errors_1_001[:-43], color(0, 5), label=f'{1}-dimensional quadrature error')
    plt.plot(k_001[:-43], rel_errors_2_001[:-43], color(1, 5), label=f'{2}-dimensional quadrature error')
    plt.plot(k_001[:-43], rel_errors_3_001[:-43], color(2, 5), label=f'{3}-dimensional quadrature error')
    plt.plot(k_001[:-43], rel_errors_4_001[:-43], color(3, 5), label=f'{4}-dimensional quadrature error')
    plt.plot(k_001[:-43], rel_errors_5_001[:-43], color(4, 5), label=f'{5}-dimensional quadrature error')
    plt.xlabel('log-moneyness')
    plt.ylabel('relative error')
    plt.legend(loc='upper right')
    plt.show()
...
with open('true surface.npy', 'rb') as f:
    true_iv_surface_eur_call = np.load(f)
