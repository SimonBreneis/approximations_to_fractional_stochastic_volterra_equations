...
rBergomi_BFG is the Bergomi smile for the BFG approximation (with log-strikes k_vec).
...
def plot_rBergomi_smiles_BFG_AK_():
    ...
    """
    plt.plot(k_vec, rBergomi_BFG, "k", label="N=infinity")
...
k_rHeston = -0.3 + 0.01*np.arange(51)

rHeston = np.array([0.25165058, 0.24992304, 0.24818719, 0.24644315, 0.24469108, 0.24293116,
                    0.24116362, 0.23938869, 0.23760669, 0.23581796, 0.23402290, 0.23222197,
                    0.23041569, 0.22860466, 0.22678955, 0.22497113, 0.22315027, 0.22132793,
                    0.21950522, 0.21768334, 0.21586367, 0.21404772, 0.21223718, 0.21043392,
                    0.20863998, 0.20685763, 0.20508934, 0.20333780, 0.20160593, 0.19989688,
                    0.19821401, 0.19656089, 0.19494131, 0.19335921, 0.19181865, 0.19032382,
                    0.18887892, 0.18748813, 0.18615554, 0.18488506, 0.18368035, 0.18254476,
                    0.18148121, 0.18049218, 0.17957960, 0.17874486, 0.17798877, 0.17731154,
                    0.17671283, 0.17619175, 0.17574690])

k_rHeston_ = -1.3 + 0.02*np.arange(81)

rHeston_ = np.array([0.39071594, 0.38782894, 0.38492131, 0.38199287, 0.37904301, 0.37607124,
...
rHeston_AK_1 = np.array([1.36379788e-10, 1.65704124e-01, 1.36379788e-10, 1.36379788e-10,
                        1.58095282e-01, 1.36379788e-10, 1.36379788e-10, 1.50267076e-01,
                        1.36354853e-01, 1.36379788e-10, 1.43422338e-01, 1.43159547e-01,
                        1.42416765e-01, 1.42083495e-01, 1.42099151e-01, 1.42130748e-01,
                        1.42154104e-01, 1.42130949e-01, 1.42112332e-01, 1.42096792e-01,
                        1.42081064e-01, 1.42065652e-01, 1.42050050e-01, 1.42034452e-01,
                        1.42018815e-01, 1.42003191e-01, 1.41987560e-01, 1.41971930e-01,
                        1.41956302e-01, 1.41940673e-01, 1.41925044e-01, 1.41909416e-01,
                        1.41893787e-01, 1.41878158e-01, 1.41862530e-01, 1.41846901e-01,
                        1.41831273e-01, 1.41815644e-01, 1.41800016e-01, 1.41784387e-01,
                        1.41768759e-01, 1.41753131e-01, 1.41737502e-01, 1.41721874e-01,
                        1.41706246e-01, 1.41690618e-01, 1.41674989e-01, 1.41659361e-01,
                        1.41643734e-01, 1.41628106e-01, 1.41612478e-01, 1.41596850e-01,
                        1.41581222e-01, 1.41565594e-01, 1.41549967e-01, 1.41534339e-01,
                        1.41518712e-01, 1.41503084e-01, 1.41487457e-01, 1.41471829e-01,
                        1.41456202e-01, 1.41440575e-01, 1.41424948e-01, 1.41409321e-01,
                        1.41393694e-01, 1.41378067e-01, 1.41362440e-01, 1.41346813e-01,
                        0.25621391, 0.25457657, 0.25292968, 0.25127310, 0.24960667, 0.24793022,
                        0.24624359, 0.24454659, 0.24283907, 0.24112083, 0.23939169, 0.23765146,
                        0.23589995, 0.23413696, 0.23236228, 0.23057571, 0.22877702, 0.22696601,
                        0.22514245, 0.22330610, 0.22145673, 0.21959411, 0.21771798, 0.21582810,
                        0.21392421, 0.21200606, 0.21007337, 0.20812588, 0.20616332, 0.20418541,
                        0.20219188, 0.20018244, 0.19815681, 0.19611473, 0.19405590, 0.19198005,
                        0.18988693, 0.18777626, 0.18564780, 0.18350132, 0.18133661, 0.17915348,
                        0.17695177, 0.17473136, 0.17249219, 0.17023425, 0.16795758, 0.16566235,
                        0.16334879, 0.16101729, 0.15866837, 0.15630273, 0.15392130, 0.15152526,
                        0.14911610, 0.14669567, 0.14426626, 0.14183064, 0.13939221, 0.13695503,
                        0.13452392, 0.13210462, 0.12970382, 0.12732929, 0.12498990, 0.12269563,
                        0.12045751, 0.11828747, 0.11619806, 0.11420207, 0.11231200, 0.11053951,
                        0.10889480, 0.10738605, 0.10601894])

rHeston_AK_32 = np.array([0.36401426, 0.36142794, 0.35882363, 0.35620095, 0.35355954, 0.35089897, #2366
                        0.34821884, 0.34551873, 0.34279818, 0.34005673, 0.33729391, 0.33450922,
                        0.33170215, 0.32887215, 0.32601867, 0.32314114, 0.32023895, 0.31731146,
                        0.31435803, 0.31137797, 0.30837057, 0.30533508, 0.30227073, 0.29917670,
                        0.29605213, 0.29289615, 0.28970780, 0.28648612, 0.28323006, 0.27993855,
                        0.27661045, 0.27324456, 0.26983962, 0.26639428, 0.26290716, 0.25937676,
                        0.25580150, 0.25217973, 0.24850968, 0.24478948, 0.24101715, 0.23719056,
                        0.23330747, 0.22936550, 0.22536208, 0.22129451, 0.21715988, 0.21295510,
                        0.20867687, 0.20432168, 0.19988579, 0.19536524, 0.19075584, 0.18605320,
                        0.18125277, 0.17634990, 0.17133997, 0.16621862, 0.16098204, 0.15562761,
                        0.15015471, 0.14456629, 0.13887121, 0.13308814, 0.12725178, 0.12142241,
                        0.11569936, 0.11023603, 0.10524649, 0.10098189, 0.09765981, 0.09537667,
                        0.09407707, 0.09360364, 0.09377099, 0.09441303, 0.09539858, 0.09663001,
                        0.09803645, 0.09956681, 0.10118423])

def plot_rHeston_smiles():
    plt.plot(k_rHeston, rHeston)
    plt.show()

    plt.plot(k_rHeston_, rHeston_)
    plt.plot(k_rHeston_, rHeston_AK_1___)
    plt.plot(k_rHeston_, rHeston_AK_2)
    plt.plot(k_rHeston_, rHeston_AK_4)
    plt.plot(k_rHeston_, rHeston_AK_32)
    plt.show()
